<footer class="full-row bg-secondary p-0">
            <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-4">
                                    <div class="footer-widget mb-4">
                                        <div class="footer-logo mb-4"> <a href="#"><h2 style="color:#20c997">HOME HARBOR</h2></a> </div>
                                        <p class="pb-20 text-white">Welcome to Home Harbor! Your hub for efficient real estate management. Explore tools, resources, and expert insights tailored to streamline your property management experience. Thank you for choosing us for your real estate journey.</p>
										</div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-lg-4">
                                            <div class="footer-widget footer-nav mb-4">
                                                ...
                                                <ul class="hover-text-primary">
                                                    ...
                                                    <li><a href="#" class="text-white">Frequently Ask Question</a></li> -->
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="footer-widget">
                                                ...
                                                <ul class="text-white">
                                                    <li class="hover-text-primary"><i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>Mumbai,Maharshtra</li>
                                                    <li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>7738914967</li>
													<li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>7738914967</li>
                                                    <li class="hover-text-primary"><i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>mishraritika579@gmail.com</li>
                                                </ul>
                                            </div>
                ...
                <div class="row copyright">
                    <div class="col-sm-6"> <span class="text-white">© 2024 Home Harbor All right reserved</span> </div>
                    <div class="col-sm-6">
